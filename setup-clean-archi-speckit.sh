...
echo ""
echo "  Then, per feature, use architecture-guard's own governed commands"
echo "  (not the plain /speckit.specify /plan /tasks /implement):"
echo ""
echo "  /speckit.architecture-guard.governed-spec"
echo "  /speckit.architecture-guard.governed-delivery"
echo "  /speckit.architecture-guard.governed-implement"
echo "  /speckit.architecture-guard.architecture-verify"
echo ""
